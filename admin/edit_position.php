...
$position = mysqli_fetch_assoc(mysqli_stmt_get_result($position_stmt));
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_sql = "UPDATE positions SET title = ?, description = ?, election_id = ? WHERE id = ?";
    $update_stmt = mysqli_prepare($conn, $update_sql);
    mysqli_stmt_bind_param($update_stmt, "ssii", $title, $description, $election_id, $position_id);
...
<head>
    ...
    <title>Edit Position - School Voting System</title>
                                ...
                                <select class="form-select" name="election_id" required>
                                    ...
                                    ?>
                                        <option value="<?php echo $election['id']; ?>" 
                                                <?php echo $election['id'] == $position['election_id'] ? 'selected' : ''; ?>>
