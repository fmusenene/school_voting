...
function printCodes() {
      ...
      printWindow.document.write(`
          ...
          <head>
              <meta charset="UTF-8">
              <title>Voting Codes - <?php echo $selected_election_id ? htmlspecialchars(current(array_filter($elections, fn($e) => $e['id'] == $selected_election_id))['title'] ?? 'Selected Election') : 'All Elections'; ?></title>
          ...
          <body>
              <h2>Voting Codes - <?php echo $selected_election_id ? htmlspecialchars(current(array_filter($elections, fn($e) => $e['id'] == $selected_election_id))['title'] ?? 'Selected Election') : 'All Elections'; ?></h2>
